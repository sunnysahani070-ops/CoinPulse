...
const apiKeyParam = WS_URL.includes('pro-api') ? 'x_cg_pro_api_key' : 'x_cg_demo_api_key';
const WS_BASE = `${WS_URL}?${apiKeyParam}=${process.env.NEXT_PUBLIC_COINGECKO_API_KEY}`;
